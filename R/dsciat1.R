...
#' results obtained with the \code{compute_sciat()} functions.
#'
#' @docType data
#' @keywords datasets
#' @name dsciat1
#' @usage data("dsciat1")
#' @format A dataframe with 15 variables, as those described in the documentation for the
#' \code{compute_sciat()}function.
"dsciat1"
